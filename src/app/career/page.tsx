        ...
        >
          <div className="relative">
            <p className="absolute text-white text-4xl font-semibold lg:text-7xl lg:top-[-20px] lg:px-24">
              Join Our Team of Experts at SN Power & Infra
            </p>
          </div>
          <div className="mt-32 lg:mt-40">
            <p className="text-white lg:text-2xl lg:px-24 text-justify">
              At SN Power & Infra, we are not just building structures; we are
              building careers. Whether you are a seasoned engineer, a skilled
              craftsman, or a passionate newcomer, SN Power & Infra offers a
      ...
      <div className="px-2 w-full max-h-auto">
        ...
        <div className="py-12">
          <p className="text-[#212020] text-justify">
            At SN Power & Infra, you all be part of a team that values quality,
        ...
        <div className="flex items-center justify-center">
          <Image
            className="max-h-auto w-full lg:w-full lg:ml-0 lg:max-h-screen"
