    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="px-2 w-full max-h-auto">
        ...
        <div className="">
          <Link
            ...
            passHref
          >
            <button className="flex items-center px-6 py-4 ml-2 font-semibold border border-[#212020] rounded-sm mt-8 mb-5 shadow-lg hover:shadow-2xl transition-shadow duration-300 hover:underline">
      ...
      <div className="">
        <Link
          ...
          passHref
        >
          <button className="flex items-center px-6 py-4 ml-2 font-semibold border border-[#212020] rounded-sm mt-14 shadow-lg hover:shadow-2xl transition-shadow duration-300 hover:underline">
            <span className="hover:underline">View Openings</span>
            <svg
              className="ml-2"
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="">
        ...
        >
          <button className="flex items-center px-6 py-4 ml-2 font-semibold border border-[#212020] rounded-sm mt-7 mb-5 shadow-lg hover:shadow-2xl transition-shadow duration-300 hover:underline">
